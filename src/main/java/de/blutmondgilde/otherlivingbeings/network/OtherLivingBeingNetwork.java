...
public class OtherLivingBeingNetwork {
    ...
    public static void registerPackets() {
        ...
        getInstance().registerMessage(messageId++, SyncFurnacePlacerCapability.class, SyncFurnacePlacerCapability::toBytes, SyncFurnacePlacerCapability::new, SyncFurnacePlacerCapability::handle);
        ...
        getInstance().registerMessage(messageId++, SyncItemDataPackPacket.class, SyncItemDataPackPacket::encode, SyncItemDataPackPacket::decode, SyncItemDataPackPacket::handle);
    }
