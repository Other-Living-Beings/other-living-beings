...
public abstract class ExpEntryDataGenerator<T extends GeneratableObject<T>> implements DataProvider {
    ...
    public ExpEntryDataGenerator(String modId, String jobName, Path outputFolder) {
        this.modId = modId;
        this.jobName = jobName;
        this.outputFolder = outputFolder.resolve("data").resolve(this.modId).resolve("skills").resolve(this.jobName);
    }
